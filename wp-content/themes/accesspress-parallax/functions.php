...
if ( !function_exists( 'accesspress_parallax_setup' ) ) :
    ...
    function accesspress_parallax_setup() {
        ...
        register_nav_menus( array(
            ...
            'sidebarmenu' => __( 'Sidebar Menu', 'accesspress-parallax' ),
            'hotel_bbsr' => __( 'Bhubaneswar Menu', 'accesspress-parallax' ),
            'hotel_puri' => __( 'Puri Menu', 'accesspress-parallax' ),
            'hotel_paradeep' => __( 'Paradeep Menu', 'accesspress-parallax' ),
        ) );
...
function accesspress_parallax_widgets_init() {
    ...
    register_sidebar( array(
        ...
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '<h3 class="widget-title"><b>',
        'after_title' => '</b></h3>',
    ) );
	...
	register_sidebar( array(
        'name' => __( 'Top Hedaer Left', 'accesspress-parallax' ),
        'id' => 'footer-5',
        'description' => '',
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
	...
	register_sidebar( array(
        'name' => __( 'Top Hedaer Right', 'accesspress-parallax' ),
        'id' => 'footer-6',
        'description' => '',
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
